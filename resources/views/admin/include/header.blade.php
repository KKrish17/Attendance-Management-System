    ...
    <ul class="nav navbar-nav navbar-left">
        <li>
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html"><img src="{{  URL::asset('public/assets/images/white-l.png')}}" width="30" alt="rkalways"><span class="m-l-10">Education in a Box</span></a>
            </div>
        </li>
                    ...
                    <ul class="menu list-unstyled">
                        <li>
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object" src="{{  URL::asset('public/assets/images/xs/avatar1.jpg')}}" alt="">
